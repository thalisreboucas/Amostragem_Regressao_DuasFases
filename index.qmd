...
## Explicação
 ...
 3. ma combinação das Situações 1 e 2. O valor $xk$  é registrado para $k \in s$ e alguma outra informação (talvez 'mais fraca') $z_k=(z_{1k,...,z_{pk})'}$ é conhecida para todas as unidades $k in U$.
