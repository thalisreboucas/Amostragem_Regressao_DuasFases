...
- Na primeira fase, selecione uma amostra relativamente grande de elementos,$s_1$,coletando informações de baixo custo sobre uma ou mais variáveis auxiliares , essas variáveis auxiliares serão utilizadas para estratificar $s_1$.
